...
async function createDb() {
  try {
    return await executeQuery(
      "CREATE TABLE users (id SERIAL PRIMARY KEY, name VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL UNIQUE, password TEXT NOT NULL, created DATE DEFAULT CURRENT_DATE);",
      [],
    );
  } catch (err) {
